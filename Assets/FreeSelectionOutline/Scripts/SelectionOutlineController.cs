...
{
    private InteractableObject _selection;

    public InteractableObject Selection { get; set; }

    public bool CanInteract { get; set; }
    [ColorUsageAttribute(true,true)]
    public Color OutlineColor = new Color(1f, 0.55f, 0f),OccludedColor=new Color(0.5f,0.9f,0.3f), AltColor = new Color(1,0.3f,0.6f);
    ...
    //     OutlineMat.SetColor("_OutlineColor", CanInteract ? OutlineColor : AltColor);
    ...
    //     if (Selection)
    //     {
    //         TargetRenderer = Selection.GetComponentInChildren<Renderer>();
    ...
    //                 }
    //                 ChildrenRenderers = Selection.GetComponentsInChildren<Renderer>();
    //             }
    //
    //
